...
function enable_stripe() {
    ...
    if (cardTypeInput.length) {
        frm.find('#cardType').closest('div.col-sm-6').slideUp('fast', function() {
            frm.find('#inputCardNumber').closest('div.col-sm-6').toggleClass('col-sm-6 col-sm-12');
        });
    } else {
        //legacy template
        frm.find('#cctype').closest('div.new-card-info').slideUp('fast');
        frm.find('#cctype').closest('tr.newccinfo').slideUp('fast');
    }
...
function disable_stripe() {
    ...
    var cardTypeInput = frm.find('#cardType');
    if (cardTypeInput.length) {
        frm.find('#inputCardNumber').closest('div.col-sm-12').toggleClass('col-sm-6 col-sm-12');
        frm.find('#cardType').closest('div.col-sm-6').slideDown('fast');
    } else {
        //legacy template
        frm.find('#cctype').closest('div.new-card-info').slideDown('fast');
        frm.find('#cctype').closest('tr.newccinfo').slideDown('fast');
    }
