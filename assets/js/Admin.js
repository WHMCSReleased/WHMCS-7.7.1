jQuery(document).ready(function(){
    ...
    // Date range picker.
    jQuery('.daterangepicker-search').daterangepicker({
        ...
        locale: {
          format: jQuery('.daterangepicker-search').data('date-format'),
          cancelLabel: 'Clear'
        }
    }).on('apply.daterangepicker', function(ev, picker) {
        var dateFormat = jQuery(this).data('date-format');
        jQuery(this).val(picker.startDate.format(dateFormat)
